class EquivalenciasCurriculares:
    ...
    def carregar_equivalencias_iniciais(self):

        self.cadastrar("ELE123", "ENG456")
        self.cadastrar("MAT014", "MAT101")
...
if __name__ == '__main__':
    ...
    print("Aprovado! Todos os testes foram revisados e a estrutura está validada.")